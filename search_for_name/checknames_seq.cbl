       ...
       FILE-CONTROL.
           ...
           SELECT IN-FILE ASSIGN TO "inputfile_seq.txt" 
               FILE STATUS IS FS-IN-FILE.
           
           SELECT OUT-FILE ASSIGN TO "outputfile_seq".
           
       
       DATA DIVISION.
       FILE SECTION.
       FD IN-FILE.
           01 IN-FILE-NAME     PIC X(20).
           01 IN-FILE-SURNAME  PIC X(20).
